...
public class FighterIncel extends Fighter
{
    ...
    public FighterIncel(PrintWriter out, String playerID, String gameID)
    {
        ...
        abilityMap.put("basicAttack", new AbilityDescription("Insult", "Basic Attack. [" + damage + " damage]", 0));
        abilityMap.put("abilityOne", new AbilityDescription("Keyboard smash", "[" + abilityOneDamage + " damage]", abilityOneEnergy));
        abilityMap.put("abilityTwo", new AbilityDescription("Black pill", "[HEAL 200 HP]", abilityTwoEnergy));
        abilityMap.put("abilityThree", new AbilityDescription("Internet harassment", "[" + abilityThreeDamage + " damage]" + "[HEAL 100 HP]", abilityThreeEnergy));
